...
import org.presentation.layer.Pictures;
...
public class XMLParser {
    ...
    public ArrayList<Film> readXML(String xmlFile){
		    ...
		    while( i < listOfDiscs.getLength()){
		    	...
		    	while(j < nameFromDiscNL.getLength()){
		    		...
		    		while(z < nameNL.getLength()){
		    			...
		    			x = new Film(disc,name,genre,rating,description,stars,"",director,duration,"",releaseDate,nameFromDisc,url,imageSrc);
		    			filmi.add(x);
	...
	public void createXML(ArrayList<Film> filmiObject,String xmlFile,boolean merge){
	...
	@SuppressWarnings("unused")
	private ArrayList<Film> getObjectNameFromDiscAndChilds(String xmlFile,String nameFromDisc,String disc){
	...
	public String updateNameChildAttribXML(String xmlFile, String disc, String movie,String name,String childAttribName,String newAttribVal){
		   ...
		   return "Filem " + movie + " je bil popravljen";
	 }
	...
	public String updateNameXML(String xmlFile, String disc, String movie,String name, String newName){
		   ...
		   return "Filem " + movie + " je bil popravljen na";
	 }
	...
	public static void convertImageURLToByteXML(String xmlFile,String disc){
		 ...
		 System.out.println("Konvertiranje slik v ByteString USPESNO!"); 
	}
